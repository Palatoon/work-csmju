...
<div class="d-sm-flex align-items-center mb-4 row">
    ...
    <div class="col-md-5">
        <form method="post" id='ddfilter' enctype="multipart/form-data" action="{{ action('Backend\HistoricalController@hour') }}">
            @csrf
        ...
        for (var i = 0; i < IoTData.length; i++) {
            switch (IoTData[i].DataCode) {
                ...
                case "ELECU":
                    ...
                    time.push(moment(new Date(IoTData[i].Timestamp)).format("HH:mm:ss"));
                    break;
                default:
                    ;
                    break;
